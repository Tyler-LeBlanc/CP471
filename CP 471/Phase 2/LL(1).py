...
first_sets = {
    ...
    "st_seq_": {"else",  "ε"},
    "expr": {"(", "a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num" },
    "expr_": {"+", "-","ε"},
    "term": {"(","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num"},
    "term_": {"*","/","%","ε"},
    "exprseq": {"(","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num"},
    "exprseq_": {",","ε"},
    "bexpr": {"(","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num","not"},
    "bexpr_": {"or", "ε"},
    "bterm": {"(", "not", "a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num"},
    "bterm_": {"and", "ε"},
    "bfactor": {"(","not","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num"},
    "comp": {"<",">","==","<=",">=", "<>"},
    "var": {"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"},
    "id": {"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"},
    "id_": {"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num", "ε"},
    "number": {"num"},
    "Double": {"num"},
    "integer": {"num"},
    "integer_": {"num", "ε"},
    "factor": {"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num","("},
...
follow_sets = {
    ...
    "comp": {"(","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num"},
    ...
    "letter": {".",";",")", "(","fed",",","int","double","=","if", "then","while","print","return","*","%","/","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num", "fi", "do", "od", "else", "+", "-", "*","/","%", "or", "and", "<>", "<", ">", "<=", ">=", "[", "]" ,"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z",},
    "digit": {".",";",")", "(","fed",",","int","double","=","if", "then","while","print","return","*","%","/","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z", "num", "fi", "do", "od", "else", "+", "-", "*","/","%", "or", "and", "<>", "<", ">", "<=", ">=", "[", "]" ,"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z",},
    "digits_":{},
    "exponent": {},
    "sign": {"num"}
